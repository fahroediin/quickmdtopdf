...
<div class="min-h-screen flex flex-col bg-white text-[#333840] font-sans antialiased">
  ...
  <footer class="bg-white border-t border-[#dddddd] py-4 px-6 text-xs text-[#8a8d94] flex justify-between items-center select-none">
    <span>Quickmdtopdf v1.0</span>
    <span>@2026 Crafted by Fahrudin</span>
  </footer>
</div>